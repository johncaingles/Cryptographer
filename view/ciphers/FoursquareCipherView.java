...
public class FoursquareCipherView extends JPanel implements ActionListener, KeyListener {
	...
	public FoursquareCipherView(MainFrame mainFrame, ICipherController controller) {
